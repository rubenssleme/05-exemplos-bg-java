...
public class ViewPagamentoPDV extends javax.swing.JDialog {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        this.desconto = Float.parseFloat(this.jtfDesconto.getText().replace(",", "."));
        this.valorRecebido = Float.parseFloat(this.jtfValorRecebido.getText().replace(",", "."));
        this.troco = Float.parseFloat(this.jtfTroco.getText().replace(",", "."));
        this.totalPagar = Float.parseFloat(this.jlfValorPagar.getText().replace(",", "."));
