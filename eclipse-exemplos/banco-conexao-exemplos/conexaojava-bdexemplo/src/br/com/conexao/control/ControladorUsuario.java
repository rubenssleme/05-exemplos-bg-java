...
import br.com.conexao.persistence.ConexaoBD;
import br.com.conexao.utilitarios.Criptografia;
...
public class ControladorUsuario extends ConexaoBD {
	...
	private static final String MENSAGEM_EXCLUIDO_COM_SUCESSO = "Excluído com sucesso\n";
	...
	private static final String MENSAGEM_USUARIO_JA_EXISTENTE = "Usuario já existente. Informe outro usuario.\n";
	private static final String MENSAGEM_USUARIO_OU_SENHA_INVALIDA = "Usuario ou senha inválido.\n";
	...
	private static final String MENSAGEM_FORMATO_INVALIDO = "Formato de número inválido";
