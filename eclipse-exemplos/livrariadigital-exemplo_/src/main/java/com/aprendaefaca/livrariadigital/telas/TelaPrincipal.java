...
import com.aprendaefaca.livrariadigital.telas.*;
...
public class TelaPrincipal extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        bVisitante = new javax.swing.JButton();
        ...
        setTitle("Livraria Digital ");

        jPanel1.setBackground(new java.awt.Color(0, 0, 0));

        bPedidos.setBackground(new java.awt.Color(0, 0, 0));
        bPedidos.setForeground(new java.awt.Color(255, 255, 255));
        bPedidos.setText("Meus Pedidos");
        ...
        bVisitante.setText("Visitante");
        bVisitante.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bVisitanteActionPerformed(evt);
            }
        });
        ...
        jTextField1.setText("Campo de Busca");

        jLabel1.setText("Livraria Digital");

        jButton5.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jButton5.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jButton5.setLabel("Meu \nCarrinho");
    ...
    private void bVisitanteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVisitanteActionPerformed
        new TelaLogin().show();
        if (Sessao.getNome() != null) {
            bVisitante.setText(Sessao.getNome());
            bVisitante.setForeground(Color.RED);
            bVisitante.setBackground(new Color(255, 255, 255));
            bVisitante.setEnabled(false);
        }


    }//GEN-LAST:event_bVisitanteActionPerformed
    ...
    private javax.swing.JButton bVisitante;
