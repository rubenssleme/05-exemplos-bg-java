...
public class Triangulo {
	...
	/*Método que verifica nome do triangulo*/
	...
	/*Método que calcula perimetro*/

	public void calculaPerimetro()
	{
		if (this.eTriangulo())
		{
			JOptionPane.showMessageDialog(null, "O perímetro do triângulo " + this.nomeTriangulo() 
			+ " é de " + String.valueOf(this.lado1 + this.lado2 + this.lado3) + " .");
		}
		else
		{
	...
	/*Método que verifica se eh triangulo*/
