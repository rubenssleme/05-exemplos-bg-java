...
public class ControladorTelaAcessoRapido extends ControladorTela {
    ...
    public ControladorTelaAcessoRapido(JFrame telaPrincipal, JDesktopPane desktop, JLabel lblConsultar, JLabel lblAluno, JLabel lblFuncionario, JLabel lblUsuario, JLabel lblProduto, JLabel lblContribuicao, JLabel lblVenda, JLabel lblCompraProduto, JLabel lblDespesa) {
